...
const Button = (props: ButtonProps) => {
  ...
  const defaultStyles =
    "rounded-full flex w-16 lg:w-20 md:w-20 h-16 lg:h-20 md:h-20 items-center justify-center md:py-5 py-2 px-2 md:px-[21px] hover:bg-[#7e0000 fixed top-[88vh] lg:top-[850px] md:top-[830px] md:left-[85vw] left-[80vw] lg:left-[92vw] z-100";
