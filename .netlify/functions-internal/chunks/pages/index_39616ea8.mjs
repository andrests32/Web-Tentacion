...
import 'html-escaper';
import { $ as $$MainLayout } from './about_0079f812.mjs';
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  const reviews = [
    {
      img: "src/icons/ico-lenceria.png",
      name: "Nattasha Mith",
  ...
  const disfraces = [
    {
      img: "src/icons/ico-disfraces.png",
      name: "Nattasha Mith",
      review: "Lorem Ipsum is simply dummy text of the typesetting industry. Ipsum has been."
    }
  ];
  const clientLogos = [
    {
      img: "public/Promos/WhatsApp Image 2024-05-29 at 11.50.07 (1).jpeg"
    },
    {
      img: "public/Promos/WhatsApp Image 2024-05-29 at 11.50.07 (3).jpeg"
    },
    {
      img: "public/Promos/WhatsApp Image 2024-05-29 at 11.50.07 (4).jpeg"
    },
    {
      img: "public/Promos/WhatsApp Image 2024-05-29 at 11.50.07 (5).jpeg"
    },
    {
      img: "public/Promos/WhatsApp Image 2024-05-29 at 11.50.08 (1).jpeg"
    },
    {
      img: "public/Promos/WhatsApp Image 2024-05-29 at 11.50.08 (2).jpeg"
    },
    {
      img: "public/Promos/WhatsApp Image 2024-05-29 at 11.50.08 (3).jpeg"
    },
    {
      img: "public/Promos/WhatsApp Image 2024-05-29 at 11.50.08 (4).jpeg"
    },
    {
      img: "public/Promos/WhatsApp Image 2024-05-29 at 11.50.08 (5).jpeg"
    },
    {
      img: "public/Promos/WhatsApp Image 2024-05-29 at 11.50.08 (6).jpeg"
    },
    {
      img: "public/Promos/WhatsApp Image 2024-05-29 at 11.50.08 (7).jpeg"
    },
    {
      img: "public/Promos/WhatsApp Image 2024-05-29 at 11.50.08.jpeg"
    },
    {
      img: "public/Promos/WhatsApp Image 2024-05-29 at 11.50.09 (1).jpeg"
    },
    {
      img: "public/Promos/WhatsApp Image 2024-05-29 at 11.50.09 (3).jpeg"
    },
    {
      img: "public/Promos/WhatsApp Image 2024-05-29 at 11.50.09 (4).jpeg"
    },
    {
      img: "public/Promos/WhatsApp Image 2024-05-29 at 11.50.09 (5).jpeg"
    },
    {
      img: "public/Promos/WhatsApp Image 2024-05-29 at 11.50.09 (6).jpeg"
    },
    {
      img: "public/Promos/WhatsApp Image 2024-05-29 at 11.50.09.jpeg"
    },
    {
      img: "public/Promos/WhatsApp Image 2024-05-29 at 11.50.10 (1).jpeg"
    },
    {
      img: "public/Promos/WhatsApp Image 2024-05-29 at 11.50.10 (2).jpeg"
    },
    {
      img: "public/Promos/WhatsApp Image 2024-05-29 at 11.50.10 (3).jpeg"
    },
    {
      img: "public/Promos/WhatsApp Image 2024-05-29 at 11.50.10 (4).jpeg"
    },
    {
      img: "public/Promos/WhatsApp Image 2024-05-29 at 11.50.10 (5).jpeg"
    },
    {
      img: "public/Promos/WhatsApp Image 2024-05-29 at 11.50.10.jpeg"
    }
  ];
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, { "title": "Tentacion", "data-astro-cid-j7pv25f6": true }, { "default": ($$result2) => renderTemplate`  ${maybeRenderHead()}<figure class="w-full lg:min-h-[110vh] flex items-center justify-center box-border" data-astro-cid-j7pv25f6> <video muted autoplay loop width="1920" height="1080" class="object-cover" data-astro-cid-j7pv25f6> <source src="public/Ne-videoBanner.mp42.mp4" type="video/mp4" data-astro-cid-j7pv25f6> </video> </figure> ${renderComponent($$result2, "Button", Button, { "data-astro-cid-j7pv25f6": true })}  <h2 class="font-dm tracking-wide text-center leading-[37px] lg:leading-[62.50px] text-[22px] lg:text-[60px] md:text-[40px]  w-full lg:max-w-[50%] pb-9 mx-auto text-text-blue lg:pt-[100px] pt-10 flex flex-col items-center justify-center" data-astro-cid-j7pv25f6>
Ponte feliz, porque regia ya estas.
<img src="public/logo-only.png" class="w-60 h-30 lg:w-[380px] lg:h-30 lg:bg-cover" data-astro-cid-j7pv25f6> </h2> <section class="lg:max-w-[1200px] px-12 xl:px-0 w-full mx-auto lg:pt-[20px] lg:flex rounded-xl mb-10 lg:mb-20" data-astro-cid-j7pv25f6> <div class="w-full flex flex-col rounded-[48px] px-6 py-[40px] justify-center items-center" data-astro-cid-j7pv25f6> <h2 class="font-dm tracking-wide text-center leading-[37px] lg:leading-[62.50px] text-[50px] lg:text-[50px] w-full lg:max-w-[50%] pb-9 mx-auto text-text-blue" data-astro-cid-j7pv25f6>
Lencería
</h2> <div class="flex flex-col gap-8 lg:gap-10 lg:flex-row" data-astro-cid-j7pv25f6> ${reviews.map((rev) => {
    return renderTemplate`<div class="w-full max-w-[370px] rounded-4xl mx-auto flex flex-col justify-center gap-4 md:gap-6" data-astro-cid-j7pv25f6> <div class="flex flex-col sm:flex-row gap-6 items-center" data-astro-cid-j7pv25f6> <img${addAttribute(rev.img, "src")} alt="" class="w-full h-full object-cover object-center" data-astro-cid-j7pv25f6> </div> </div>`;
...
</h2> <div class="w-full h-100 flex flex-row justify-between items-center gap-12 max-w-[1200px] overflow-x-scroll no-scrollbar rounded-xl" data-astro-cid-j7pv25f6> ${renderComponent($$result2, "CgChevronRight", CgChevronRight, { "className": "absolute text-6xl right-3 text-text-blue/30", "data-astro-cid-j7pv25f6": true })} ${clientLogos.map((logo) => renderTemplate`<img${addAttribute(logo.img, "src")} alt="" class="object-contain object-center h-80" data-astro-cid-j7pv25f6>`)} ${renderComponent($$result2, "CgChevronLeft", CgChevronLeft, { "className": "absolute text-6xl left-1 text-text-blue/30", "data-astro-cid-j7pv25f6": true })} </div> </section> ` })} `;
